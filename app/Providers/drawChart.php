...
class DrawChart
{
  ...
  //  public $chart;
    ...
    public function graph($return, $risk){
        ...
        $frontierPicture->setFontProperties(array("FontName" => "/var/www/html/mvo/app/Providers/pChart2.1.4/fonts/GeosansLight.ttf", "FontSize" => 14));
       ...
       // return $frontierPicture->autoOutput("pictures/example.drawScatterPlotChart.png");
        //header("Content-Type: image/png");
        $frontierPicture->Render("/var/www/html/mvo/public/chart.png");
