    ...
    double                             T)
{
  ...
  Variable::t flow       = M->variable("traffic_flow", NxN, Domain::greaterThan(0.0));
  
  Variable::t x = flow;
  Variable::t t = M->variable("travel_time", NxN, Domain::greaterThan(0.0));
  Variable::t d = M->variable("d",           NxN, Domain::greaterThan(0.0));
  Variable::t z = M->variable("z",           NxN, Domain::greaterThan(0.0));
