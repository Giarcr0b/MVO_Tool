...
def tsp(n, A, C, graph_topology, remove_selfloops, remove_2_hop_loops):
...
def main():
    ...
    x,c = tsp(n, Matrix.sparse(n,n,A_i,A_j,1.), costs , True, True, True)

    x,c = tsp(n, Matrix.sparse(n,n,A_i,A_j,1.), costs , True, True, False)
